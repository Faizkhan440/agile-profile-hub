...
const Achievements = () => {
  ...
  return (
    <section id="achievements" className="section-container bg-navy-dark relative">
        ...
        <div className="animate-fade-in-up">
          ...
          <div className="space-y-5">
            {achievements.map((item, index) => (
              <Card key={index} className="bg-navy-light/50 glass-effect border-none shadow-lg card-hover">
